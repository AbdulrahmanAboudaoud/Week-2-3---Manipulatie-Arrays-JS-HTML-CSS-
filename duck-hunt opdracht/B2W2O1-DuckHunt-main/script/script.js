...
function gameOver() {
	...
	if (totalScore >= 20) {
		...
		if (hitScore <= 5) {
			gameplayFeedback.innerHTML = "Are you even trying ?";
		}
		else if (hitScore > 5 && hitScore <= 12) {
			gameplayFeedback.innerHTML = "Good but not the best ! ";
		}
		else if (hitScore > 12 && hitScore < 20) {
			gameplayFeedback.innerHTML = "GG wp ";
		}
		else {
			gameplayFeedback.innerHTML = "Ducks will hate you for ever <br>.";
		}
